      ...
      function (e, t, n) {
        !(function (e, n) {
          ...
          function d(e, t, n, r) {
            ...
            return (
              n && ((l = +l || +u || 0), (o = n[1] ? l + (n[1] + 1) * n[2] : +n[2]), r && ((r.unit = c), (r.start = l), (r.end = o))),
              o
            )
          }
          function g(e) {
                      ...
                      (n = s[t]),
                        ...
                        s !== r &&
                          (c && r && (de.isPlainObject(r) || (o = de.isArray(r)))
                            ? (o ? ((o = !1), (i = n && de.isArray(n) ? n : [])) : (i = n && de.isPlainObject(n) ? n : {}),
                              (s[t] = de.extend(c, i, r)))
                            : void 0 !== r && (s[t] = r))
                return s
              }),
            de.extend({
              ...
              isPlainObject: function (e) {
                ...
                return (
                  ...
                  (!(t = ne(e)) || ((n = ce.call(t, 'constructor') && t.constructor), 'function' == typeof n && le.call(n) === fe))
                )
              },
              ...
              if (!r && ((t ? t.ownerDocument || t : W) !== L && O(t), (t = t || L), F)) {
                ...
                if (T.qsa && !X[e + ' '] && (!R || !R.test(e))) {
                  if (1 !== d) (p = t), (l = e)
                    ...
                    for (
                      (a = t.getAttribute('id')) ? (a = a.replace(we, Te)) : t.setAttribute('id', (a = $)), c = E(e), i = c.length;
                      i--;
              ...
              for (
                ...
                if ((n = C.relative[e[a].type])) l = [d(g(l), n)]
                  ...
                  if (((n = C.filter[e[a].type].apply(null, e[a].matches)), n[$])) {
                    ...
                    return y(
                      a > 1 && g(l),
                      a > 1 && h(e.slice(0, a - 1).concat({ value: ' ' === e[a - 2].type ? '*' : '' })).replace(ae, '$1'),
                      n,
                      a < r && x(e.slice(a, r)),
                      r < o && x((e = e.slice(r))),
                      r < o && h(e)
                  ...
                  return r !== L && 9 === r.nodeType && r.documentElement
                    ? ((L = r),
                      ...
                      (T.matchesSelector = me.test(
                        (P = H.matches || H.webkitMatchesSelector || H.mozMatchesSelector || H.oMatchesSelector || H.msMatchesSelector)
                      )) &&
                        o(function (e) {
                              ...
                              if (((d = [s ? m.firstChild : m.lastChild]), s && y)) {
                                ...
                                for (
                                  ...
                                  ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) ||
                                    !++x ||
                                    (y && ((f = p[$] || (p[$] = {})), (l = f[p.uniqueID] || (f[p.uniqueID] = {})), (l[e] = [B, x])),
                                    p !== t));
                ...
                function (e, n) {
                  ...
                  for (a = e, u = [], c = C.preFilter; a; ) {
                    ;(r && !(o = ue.exec(a))) || (o && (a = a.slice(o[0].length) || a), u.push((i = []))),
                      (r = !1),
                      (o = ce.exec(a)) && ((r = o.shift()), i.push({ value: r, type: o[0].replace(ae, ' ') }), (a = a.slice(r.length)))
                    for (s in C.filter)
                      !(o = he[s].exec(a)) ||
                        (c[s] && !(o = c[s](o))) ||
          ...
          var ke,
            ...
            Se = (de.fn.init = function (e, t, n) {
              ...
              if (((n = n || ke), 'string' == typeof e)) {
                if (
                  ((r = '<' === e[0] && '>' === e[e.length - 1] && e.length >= 3 ? [null, e, null] : Ee.exec(e)), !r || (!r[1] && t))
                )
          ...
          ;(de.Callbacks = function (e) {
            ...
            de.extend({
              ...
              when: function (e) {
                ...
                if (t <= 1 && (c(e, i.done(s(n)).resolve, i.reject), 'pending' === i.state() || de.isFunction(o[n] && o[n].then)))
                  return i.then()
              ...
              data: function (e, t) {
                ...
                if (void 0 === e) {
                  if (this.length && ((o = Re.get(i)), 1 === i.nodeType && !Fe.get(i, 'hasDataAttrs'))) {
                    for (n = s.length; n--; )
                      s[n] && ((r = s[n].name), 0 === r.indexOf('data-') && ((r = de.camelCase(r.slice(5))), h(i, r, o[r])))
              ...
              if (m && (u = m.events)) {
                for (t = (t || '').match(qe) || [''], c = t.length; c--; )
                  if (((a = Ze.exec(t[c]) || []), (h = g = a[1]), (d = (a[2] || '').split('.').sort()), h)) {
                    ...
                    s &&
                      !p.length &&
                      ((f.teardown && f.teardown.call(e, d, m.handle) !== !1) || de.removeEvent(e, h, m.handle), delete u[h])
              ...
              return (
                de.fx.off || te.hidden
                  ...
                  : 'number' != typeof r.duration &&
                    (r.duration in de.fx.speeds ? (r.duration = de.fx.speeds[r.duration]) : (r.duration = de.fx.speeds._default)),
              ...
              serializeArray: function () {
                return this.map(function () {
                  ...
                  .filter(function () {
                    var e = this.type
                    return (
                      this.name && !de(this).is(':disabled') && At.test(this.nodeName) && !Nt.test(e) && (this.checked || !ze.test(e))
                    )
                  })
                  .map(function (e, t) {
                    var n = de(this).val()
      ...
      function (e, t, n) {
        ;(function (e) {
          !(function (r) {
            ...
            if (
              ((x = { version: '1.4.1', ucs2: { decode: a, encode: u }, decode: p, encode: h, toASCII: g, toUnicode: d }),
          ...
          if (((a = a.trim()), !n && 1 === e.split('#').length)) {
            ...
            if (f)
              return (
                ...
                (this.pathname = f[1]),
                f[2]
                  ? ((this.search = f[2]), t ? (this.query = j.parse(this.search.substr(1))) : (this.query = this.search.substr(1)))
