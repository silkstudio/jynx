      ...
      function (e, t, n) {
        !(function (e, n) {
          ...
          function d(e, t, n, r) {
            ...
            return (
              n && ((c = +c || +u || 0), (o = n[1] ? c + (n[1] + 1) * n[2] : +n[2]), r && ((r.unit = l), (r.start = c), (r.end = o))),
              o
            )
          }
          function g(e) {
            ...
            de.extend({
              ...
              isPlainObject: function (e) {
                ...
                return (
                  ...
                  (!(t = ne(e)) || ((n = le.call(t, 'constructor') && t.constructor), 'function' == typeof n && ce.call(n) === fe))
                )
              },
              ...
              if (!r && ((t ? t.ownerDocument || t : _) !== L && O(t), (t = t || L), F)) {
                ...
                if (C.qsa && !X[e + ' '] && (!P || !P.test(e))) {
                  if (1 !== d) (p = t), (c = e)
                    ...
                    for (
                      (s = t.getAttribute('id')) ? (s = s.replace(we, Ce)) : t.setAttribute('id', (s = $)), l = E(e), i = l.length;
                      i--;
              ...
              for (
                ...
                if ((n = T.relative[e[s].type])) c = [d(g(c), n)]
                  ...
                  if (((n = T.filter[e[s].type].apply(null, e[s].matches)), n[$])) {
                    ...
                    return y(
                      s > 1 && g(c),
                      s > 1 && h(e.slice(0, s - 1).concat({ value: ' ' === e[s - 2].type ? '*' : '' })).replace(se, '$1'),
                      n,
                      s < r && b(e.slice(s, r)),
                      r < o && b((e = e.slice(r))),
                      r < o && h(e)
                              ...
                              if (((d = [a ? m.firstChild : m.lastChild]), a && y)) {
                                ...
                                for (
                                  ...
                                  ((s ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) ||
                                    !++b ||
                                    (y && ((f = p[$] || (p[$] = {})), (c = f[p.uniqueID] || (f[p.uniqueID] = {})), (c[e] = [W, b])),
                                    p !== t));
              ...
              serializeArray: function () {
                return this.map(function () {
                  ...
                  .filter(function () {
                    var e = this.type
                    return (
                      this.name && !de(this).is(':disabled') && At.test(this.nodeName) && !St.test(e) && (this.checked || !ze.test(e))
                    )
                  })
                  .map(function (e, t) {
                    var n = de(this).val()
      ...
      function (e, t, n) {
        !(function (e, n, r) {
          ...
          function s(e) {
            var t = []
            return (
              e.shiftKey && t.push('shift'), e.altKey && t.push('alt'), e.ctrlKey && t.push('ctrl'), e.metaKey && t.push('meta'), t
            )
          }
          function u(e) {
      ...
      function (e, t, n) {
        ;(function (e) {
          !(function (r) {
            ...
            if (
              ((b = { version: '1.4.1', ucs2: { decode: s, encode: u }, decode: p, encode: h, toASCII: g, toUnicode: d }),
          ...
          if (((s = s.trim()), !n && 1 === e.split('#').length)) {
            ...
            if (f)
              return (
                ...
                (this.pathname = f[1]),
                f[2]
                  ? ((this.search = f[2]), t ? (this.query = k.parse(this.search.substr(1))) : (this.query = this.search.substr(1)))
    ...
    16: [
      function (e, t, n) {
        ...
        function s(e) {
          return (
            (e = p.extend(
              { label: '', icon: '', text: '', position: 'left', className: '', onClick: i, dropdown: null, index: null, id: r() },
              e || {}
            )),
            d.push(e),
            u(e),
