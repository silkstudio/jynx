...
import { BaseTheme, ResponsiveArray, BaseExtensibleObject } from '../types'
...
const parseResponsiveArray = <P extends keyof CSSProperties, T extends BaseTheme = BaseTheme>(
  property: P,
